...
{
    public function format($baseUrl, $relativeUrl)
    {
        return $this->urlToAbsolute($baseUrl, $relativeUrl);
    }
    /**
     *
     * @param type $baseUrl
     ...
     * @return boolean
     */
    function splitUrl($url, $decode = FALSE)
    {
     ...
     * @return string
     */
    function joinUrl($parts, $encode = FALSE)
    {
        if ($encode) {
            if (isset($parts['user']))
